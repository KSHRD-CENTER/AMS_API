...
<head>
  <meta charset="UTF-8">
  <title>AMS APPLICATION API</title>
      ...
      function addApiKeyAuthorization(){
        ...
        if(key && key.trim() != "") {
           /*  var apiKeyAuth = new SwaggerClient.ApiKeyAuthorization("api_key", key, "query");
            ...
            var apiKeyAuth = new SwaggerClient.ApiKeyAuthorization("Authorization", "Basic QU1TQVBJQURNSU46QU1TQVBJUEBTU1dPUkQ=", "header");
...
<body class="swagger-section">
	<div id='header'>
	  <div class="swagger-ui-wrap">
	    <a id="logo" href="http://khmeracademy.org">AMS APPLICATION API</a>
